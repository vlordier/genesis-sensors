...
> rest use diagnostic plots — all generated by our code with
> `PYTHONPATH=src python examples/generate_sensor_doc_assets.py --output-dir docs/assets/sensors`.
> Each sensor section below now includes a **Generated example** panel showing
> the emitted output directly in the documentation.
