...
> The gallery below embeds those generated outputs directly in the docs.
...
These figures are **generated by the actual sensor models in this repo**, not
static mockups. Image-like sensors render real snapshots from their observation
arrays; scalar sensors render diagnostic plots from their emitted measurements.

### Navigation Outputs

**IMU**
![IMU output](assets/sensors/imu.svg)

**GNSS**
![GNSS output](assets/sensors/gnss.svg)

**Barometer**
![Barometer output](assets/sensors/barometer.svg)

**Magnetometer**
![Magnetometer output](assets/sensors/magnetometer.svg)

**Airspeed**
![Airspeed output](assets/sensors/airspeed.svg)

**Optical Flow**
![Optical flow output](assets/sensors/optical_flow.svg)

**Wheel Odometry**
![Wheel odometry output](assets/sensors/wheel_odometry.svg)
...
### Range-Sensing Outputs

**Rangefinder**
![Rangefinder output](assets/sensors/rangefinder.svg)

**Ultrasonic Array**
![Ultrasonic output](assets/sensors/ultrasonic.svg)
...
**DVL**
![DVL output](assets/sensors/dvl.svg)

**Current Profiler**
![Current profiler output](assets/sensors/acoustic_current_profiler.svg)

### Environmental Outputs

**Thermometer**
![Thermometer output](assets/sensors/thermometer.svg)

**Hygrometer**
![Hygrometer output](assets/sensors/hygrometer.svg)

**Light Sensor**
![Light sensor output](assets/sensors/light_sensor.svg)

**Gas Sensor**
![Gas sensor output](assets/sensors/gas_sensor.svg)

**Anemometer**
![Anemometer output](assets/sensors/anemometer.svg)

**Battery**
![Battery output](assets/sensors/battery.svg)

### Communication Outputs

**Radio Link**
![Radio output](assets/sensors/radio.svg)

**UWB Ranging**
![UWB output](assets/sensors/uwb_ranging.svg)
...
**Force / Torque**
![Force-torque output](assets/sensors/force_torque.svg)

**Joint State**
![Joint state output](assets/sensors/joint_state.svg)

**Contact Sensor**
![Contact output](assets/sensors/contact_sensor.svg)

**Tactile Array**
![Tactile array output](assets/sensors/tactile_array.svg)

**Current Sensor**
![Current sensor output](assets/sensors/current_sensor.svg)

**RPM Sensor**
![RPM sensor output](assets/sensors/rpm_sensor.svg)
